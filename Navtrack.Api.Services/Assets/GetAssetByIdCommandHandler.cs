...
{
    [Service(typeof(IRequestHandler<GetAssetByIdCommand, AssetModel>))]
    public class GetAssetByIdCommandHandler : BaseRequestHandler<GetAssetByIdCommand, AssetModel>
    {
