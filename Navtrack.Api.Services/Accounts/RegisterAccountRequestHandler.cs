...
{
    [Service(typeof(IRequestHandler<RegisterAccountModel>))]
    public class RegisterAccountRequestHandler : BaseRequestHandler<RegisterAccountModel>
    {
        private readonly IUserDataService userDataService;
        private readonly IMapper mapper;

        public RegisterAccountRequestHandler(IUserDataService userDataService, IMapper mapper)
        {
