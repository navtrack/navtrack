...
public class CanTrackProtocolTests : BaseProtocolTests<CanTrackProtocol, CanTrackMessageHandler>
{
    ...
    {
        ProtocolTester.SendStringFromDevice(
            "*HQ,865205030330012,V2,150421,A,2240.55841,N,11358.33462,E,2.06,0,100815,FFFFFBFF#");
    ...
    {
        ProtocolTester.SendStringFromDevice(
            "*HQ,865205030330012,V4,S2,150950,151007,A,2240.55503,N,11358.35174,E,0.85,0,100815,FFFFFBFF#");
