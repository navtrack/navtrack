...
namespace Navtrack.Listener.Protocols.ATrack
{
    ...
    public class ATrackMessageHandler : BaseMessageHandler<ATrackProtocol>
    {
        ...
        {
            List<byte> response = new List<byte> {0xFE, 0x02};
        ...
        private static DateTime GetDateTime(ByteReader byteReader, MessageInput input)
        {
            ...
            {
                DateTime date2 = new DateTime(byteReader.GetLe<short>(), byteReader.GetOne(), byteReader.GetOne(),
        ...
        {
            StringReader stringReader = new StringReader(input.DataMessage.String);
