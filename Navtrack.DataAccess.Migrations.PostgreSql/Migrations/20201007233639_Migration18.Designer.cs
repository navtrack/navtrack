...
namespace Navtrack.DataAccess.Migrations.PostgreSql.Migrations
{
    ...
    [Migration("20201007233639_Migration18")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Navtrack.DataAccess.Model.LocationEntity", b =>
                {
                    ...
                    b.HasIndex("DeviceConnectionMessageId");
            ...
            modelBuilder.Entity("Navtrack.DataAccess.Model.TripEntity", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
            ...
            modelBuilder.Entity("Navtrack.DataAccess.Model.LocationEntity", b =>
                {
                    ...
                    b.HasOne("Navtrack.DataAccess.Model.DeviceConnectionMessageEntity", "ConnectionMessage")
                        .WithMany("Locations")
                        .HasForeignKey("DeviceConnectionMessageId")
                        .OnDelete(DeleteBehavior.NoAction);
