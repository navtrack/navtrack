...
export const getAssetsAssetsAssetIdUsers = (
    assetId: string,
 signal?: AbortSignal
) => {
      return authAxiosInstance<AssetUserListModel>(
      {url: `/assets/assets/${assetId}/users`, method: 'get', signal
    },
      );
    }
  

export const getGetAssetsAssetsAssetIdUsersQueryKey = (assetId: string,) => [`/assets/assets/${assetId}/users`] as const;
  

    
export const getGetAssetsAssetsAssetIdUsersQueryOptions = <TData = Awaited<ReturnType<typeof getAssetsAssetsAssetIdUsers>>, TError = ProblemDetails>(assetId: string, options?: { query?:UseQueryOptions<Awaited<ReturnType<typeof getAssetsAssetsAssetIdUsers>>, TError, TData>, }
): UseQueryOptions<Awaited<ReturnType<typeof getAssetsAssetsAssetIdUsers>>, TError, TData> & { queryKey: QueryKey } => {
const {query: queryOptions} = options ?? {};

  const queryKey =  queryOptions?.queryKey ?? getGetAssetsAssetsAssetIdUsersQueryKey(assetId);

  
  
    const queryFn: QueryFunction<Awaited<ReturnType<typeof getAssetsAssetsAssetIdUsers>>> = ({ signal }) => getAssetsAssetsAssetIdUsers(assetId, signal);
    
      
      
   return  { queryKey, queryFn, enabled: !!(assetId), ...queryOptions}}

export type GetAssetsAssetsAssetIdUsersQueryResult = NonNullable<Awaited<ReturnType<typeof getAssetsAssetsAssetIdUsers>>>
export type GetAssetsAssetsAssetIdUsersQueryError = ProblemDetails

export const useGetAssetsAssetsAssetIdUsers = <TData = Awaited<ReturnType<typeof getAssetsAssetsAssetIdUsers>>, TError = ProblemDetails>(
 assetId: string, options?: { query?:UseQueryOptions<Awaited<ReturnType<typeof getAssetsAssetsAssetIdUsers>>, TError, TData>, }

  ):  UseQueryResult<TData, TError> & { queryKey: QueryKey } => {

  const queryOptions = getGetAssetsAssetsAssetIdUsersQueryOptions(assetId,options)
...
export const postAssetsAssetsAssetIdUsers = (
    assetId: string,
    addUserToAssetModel: AddUserToAssetModel,
 ) => {
      return authAxiosInstance<void>(
      {url: `/assets/assets/${assetId}/users`, method: 'post',
      headers: {'Content-Type': 'application/json', },
...
export const getPostAssetsAssetsAssetIdUsersMutationOptions = <TError = ErrorModel,
    
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof postAssetsAssetsAssetIdUsers>>, TError,{assetId: string;data: AddUserToAssetModel}, TContext>, }
): UseMutationOptions<Awaited<ReturnType<typeof postAssetsAssetsAssetIdUsers>>, TError,{assetId: string;data: AddUserToAssetModel}, TContext> => {
 const {mutation: mutationOptions} = options ?? {};

      


      const mutationFn: MutationFunction<Awaited<ReturnType<typeof postAssetsAssetsAssetIdUsers>>, {assetId: string;data: AddUserToAssetModel}> = (props) => {
          const {assetId,data} = props ?? {};

          return  postAssetsAssetsAssetIdUsers(assetId,data,)
        }
   ...
   return  { mutationFn, ...mutationOptions }}
    ...
    export type PostAssetsAssetsAssetIdUsersMutationResult = NonNullable<Awaited<ReturnType<typeof postAssetsAssetsAssetIdUsers>>>
    export type PostAssetsAssetsAssetIdUsersMutationBody = AddUserToAssetModel
    export type PostAssetsAssetsAssetIdUsersMutationError = ErrorModel

    export const usePostAssetsAssetsAssetIdUsers = <TError = ErrorModel,
    
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof postAssetsAssetsAssetIdUsers>>, TError,{assetId: string;data: AddUserToAssetModel}, TContext>, }
) => {
    
      const mutationOptions = getPostAssetsAssetsAssetIdUsersMutationOptions(options);
     
      return useMutation(mutationOptions);
    }
    
export const deleteAssetsAssetsAssetIdUsersUserId = (
    assetId: string,
    userId: string,
 ) => {
      return authAxiosInstance<void>(
      {url: `/assets/assets/${assetId}/users/${userId}`, method: 'delete'
    },
      );
    }
...
export const getDeleteAssetsAssetsAssetIdUsersUserIdMutationOptions = <TError = ErrorModel,
    
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof deleteAssetsAssetsAssetIdUsersUserId>>, TError,{assetId: string;userId: string}, TContext>, }
): UseMutationOptions<Awaited<ReturnType<typeof deleteAssetsAssetsAssetIdUsersUserId>>, TError,{assetId: string;userId: string}, TContext> => {
 const {mutation: mutationOptions} = options ?? {};

      


      const mutationFn: MutationFunction<Awaited<ReturnType<typeof deleteAssetsAssetsAssetIdUsersUserId>>, {assetId: string;userId: string}> = (props) => {
          const {assetId,userId} = props ?? {};

          return  deleteAssetsAssetsAssetIdUsersUserId(assetId,userId,)
        }
   ...
   return  { mutationFn, ...mutationOptions }}
    ...
    export type DeleteAssetsAssetsAssetIdUsersUserIdMutationResult = NonNullable<Awaited<ReturnType<typeof deleteAssetsAssetsAssetIdUsersUserId>>>
    
    export type DeleteAssetsAssetsAssetIdUsersUserIdMutationError = ErrorModel

    export const useDeleteAssetsAssetsAssetIdUsersUserId = <TError = ErrorModel,
    
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof deleteAssetsAssetsAssetIdUsersUserId>>, TError,{assetId: string;userId: string}, TContext>, }
) => {
    
      const mutationOptions = getDeleteAssetsAssetsAssetIdUsersUserIdMutationOptions(options);
