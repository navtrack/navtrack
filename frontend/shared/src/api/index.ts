...
>(options?: {
  ...
  TContext
> => {
  const mutationKey = ["accountCreateAccount"];
...
export function useAssetsGetList<
  TData = Awaited<ReturnType<typeof assetsGetList>>,
  TError = unknown
>(
  organizationId: string,
...
export type AssetsGetQueryResult = NonNullable<
  Awaited<ReturnType<typeof assetsGet>>
>;
export type AssetsGetQueryError = ProblemDetails | ProblemDetails;

export function useAssetsGet<
  TData = Awaited<ReturnType<typeof assetsGet>>,
  TError = ProblemDetails | ProblemDetails
>(
  assetId: string,
...
>(options?: {
  ...
  TContext
> => {
  const mutationKey = ["assetsUpdate"];
  const { mutation: mutationOptions } = options
    ? options.mutation &&
      "mutationKey" in options.mutation &&
      options.mutation.mutationKey
...
>(options?: {
  ...
  TContext
> => {
  const mutationKey = ["assetsDelete"];
  const { mutation: mutationOptions } = options
    ? options.mutation &&
      "mutationKey" in options.mutation &&
      options.mutation.mutationKey
...
export function useAssetsDevicesGetList<
  TData = Awaited<ReturnType<typeof assetsDevicesGetList>>,
  TError = ProblemDetails
>(
  assetId: string,
...
>(options?: {
  ...
  TContext
> => {
  const mutationKey = ["assetsDevicesCreateOrUpdate"];
  const { mutation: mutationOptions } = options
    ? options.mutation &&
      "mutationKey" in options.mutation &&
      options.mutation.mutationKey
...
>(options?: {
  ...
  TContext
> => {
  const mutationKey = ["assetsDevicesDelete"];
  const { mutation: mutationOptions } = options
    ? options.mutation &&
      "mutationKey" in options.mutation &&
      options.mutation.mutationKey
...
export function useAssetsMessagesGetList<
  TData = Awaited<ReturnType<typeof assetsMessagesGetList>>,
  TError = ProblemDetails
>(
  assetId: string,
...
export function useAssetsReportsGetDistanceReport<
  TData = Awaited<ReturnType<typeof assetsReportsGetDistanceReport>>,
  TError = ProblemDetails
>(
  assetId: string,
...
export function useAssetsStatsGet<
  TData = Awaited<ReturnType<typeof assetsStatsGet>>,
  TError = ProblemDetails
>(
  assetId: string,
...
export function useAssetsTripsGetList<
  TData = Awaited<ReturnType<typeof assetsTripsGetList>>,
  TError = ProblemDetails
>(
  assetId: string,
...
export function useAssetsUsersGetList<
  TData = Awaited<ReturnType<typeof assetsUsersGetList>>,
  TError = ProblemDetails
>(
  assetId: string,
...
>(options?: {
  ...
  TContext
> => {
  const mutationKey = ["assetsUsersCreate"];
  const { mutation: mutationOptions } = options
    ? options.mutation &&
      "mutationKey" in options.mutation &&
      options.mutation.mutationKey
...
>(options?: {
  ...
  TContext
> => {
  const mutationKey = ["assetsUsersDelete"];
  const { mutation: mutationOptions } = options
    ? options.mutation &&
      "mutationKey" in options.mutation &&
      options.mutation.mutationKey
...
export function useDevicesGetList<
  TData = Awaited<ReturnType<typeof devicesGetList>>,
  TError = unknown
>(options?: {
  query?: UseQueryOptions<
...
export type OrganizationsListQueryResult = NonNullable<
  Awaited<ReturnType<typeof organizationsList>>
>;
export type OrganizationsListQueryError = ProblemDetails | ProblemDetails;
...
export type OrganizationsGetQueryResult = NonNullable<
  Awaited<ReturnType<typeof organizationsGet>>
>;
export type OrganizationsGetQueryError = ProblemDetails | ProblemDetails;
...
export function useOrganizationsUsersList<
  TData = Awaited<ReturnType<typeof organizationsUsersList>>,
  TError = unknown
>(
  organizationId: string,
...
>(options?: {
  ...
  TContext
> => {
  const mutationKey = ["organizationsUsersCreate"];
  const { mutation: mutationOptions } = options
    ? options.mutation &&
      "mutationKey" in options.mutation &&
      options.mutation.mutationKey
...
>(options?: {
  ...
  TContext
> => {
  const mutationKey = ["organizationsUsersUpdate"];
  const { mutation: mutationOptions } = options
    ? options.mutation &&
      "mutationKey" in options.mutation &&
      options.mutation.mutationKey
...
>(options?: {
  ...
  TContext
> => {
  const mutationKey = ["organizationsUsersDelete"];
  const { mutation: mutationOptions } = options
    ? options.mutation &&
      "mutationKey" in options.mutation &&
      options.mutation.mutationKey
...
export function useProtocolsGetList<
  TData = Awaited<ReturnType<typeof protocolsGetList>>,
  TError = unknown
>(options?: {
  query?: UseQueryOptions<
...
export function useTeamsAssetsList<
  TData = Awaited<ReturnType<typeof teamsAssetsList>>,
  TError = ProblemDetails
>(
  teamId: string,
...
>(options?: {
  ...
  TContext
> => {
  const mutationKey = ["teamsAssetsDelete"];
  const { mutation: mutationOptions } = options
    ? options.mutation &&
      "mutationKey" in options.mutation &&
      options.mutation.mutationKey
...
export function useTeamsGetList<
  TData = Awaited<ReturnType<typeof teamsGetList>>,
  TError = unknown
>(
  organizationId: string,
...
export function useTeamsUsersList<
  TData = Awaited<ReturnType<typeof teamsUsersList>>,
  TError = ProblemDetails
>(
  teamId: string,
...
>(options?: {
  ...
  TContext
> => {
  const mutationKey = ["teamsUsersDelete"];
  const { mutation: mutationOptions } = options
    ? options.mutation &&
      "mutationKey" in options.mutation &&
      options.mutation.mutationKey
